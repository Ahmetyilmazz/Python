...
while 1:
    ...
    secim = int(input("Mod Seçiniz (1:Açık_Mod//2:Gizli_Mod): "))
    ...
    if secim == 1:
        ...
        for i in range(0,oyuncu_atis_hakki):
            ...
            if (atis_x < 0) | (atis_x >= oyun_alani_buyuklugu):
                ...
                elif (oyun_alani[atis_x][atis_y] == " o ") :
                    print("==> Tebrikler Bir Gemi Vurdunuz ! ") # Geminin Bütün Bölümleri vurulduysa Tebrikler bir gemi batırdınız mesajı da verilecek.
                    oyun_alani[atis_x][atis_y] = " X "
        ...
        # Gemi uçları yerleştirme    
        '''
        oyun_alani[ gemi_1[0][0] ][ gemi_1[0][1] ] = " ? "
        oyun_alani[ gemi_1[1][0] ][ gemi_1[1][1] ] = " ? "

        oyun_alani[ gemi_2[0][0] ][ gemi_2[0][1] ] = " ? "
        oyun_alani[ gemi_2[1][0] ][ gemi_2[1][1] ] = " ? "

        oyun_alani[ gemi_3[0][0] ][ gemi_3[0][1] ] = " ? "
        oyun_alani[ gemi3_noktalistesi[1][0]][gemi3_noktalistesi[1][1]] = " ? "
        oyun_alani[ gemi_3[1][0] ][ gemi_3[1][1] ] = " ? "

        oyun_alani[ gemi_4[0][0] ][ gemi_4[0][1] ] = " ? "
        oyun_alani[ gemi4_noktalistesi[1][0]][gemi4_noktalistesi[1][1]] = " ? "
        oyun_alani[ gemi4_noktalistesi[2][0]][gemi4_noktalistesi[2][1]] = " ? "
        oyun_alani[ gemi_4[1][0] ][ gemi_4[1][1] ] = " ? "
        '''
