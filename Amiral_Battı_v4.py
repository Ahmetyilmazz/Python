...
while 1:
    ...
    """ 
    gemiler = [gemi_1, gemi_2, gemi_3, gemi_4]
    atis_secimi_x = int(input("Vurmak İstediğiniz Noktanın x koordinatını yazınız:")) #Buradan devammm
    atis_secimi_y = int(input("Vurmak İstediğiniz Noktanın y koordinatını yazınız:"))
    
    if (atis_secimi_x == gemiler) & (atis_secimi_y == gemiler) :
        print("Tebrikler 1 gemi vurdunuz ! ")
        continue
    else:
        print("Maalesef gemi vuramadınız.") 
        """
...
# DEVAM EDERİM DİYE AÇTIĞIM EK DOSYA DEĞİŞİKLİK YAPACAĞIM YANİ .
